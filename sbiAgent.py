...
class SBISecurities(Securities):
    ...
    def __init__(self, uid, upass, tpass):
        """Init this instance."""
        self.userID = uid
    ...
    def login(self):
        ...
        #
        # ログイン
        r = self.session.get('https://www.sbisec.co.jp/ETGate', headers=self.defHeaders)
...
if __name__ == '__main__':
    ...
    userid=config['login']['uid']
    passwd=config['login']['pwd']
    passw2=config['login']['pwd2']
    
    
    sec = SBISecurities(userid,passwd,passw2)
